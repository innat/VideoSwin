...
- [09-10-2023]: VideoSwin integrated into [Huggingface Space]().
- [12-10-2023]: GPU(s), TPU-VM for fine-tune training are supported, [colab]().
- [9-10-2023]: TensorFlow [SavedModel](https://www.tensorflow.org/guide/saved_model) (formet) checkpoints, [link](https://github.com/innat/VideoSwin/releases/tag/v1.1).
...
- [05-10-2023]: Code of VideoSwin in Keras becomes available.
